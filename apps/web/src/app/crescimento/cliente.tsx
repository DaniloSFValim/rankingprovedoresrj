...
interface PaginaCrescimentoProps {
  cidades: CidadeOpcao[];
  movimentacoes: Movimentacoes;
  ranking: LinhaRankingEstadual[];
  meta: Meta;
  municipiosPerfis: Record<string, PerfilMunicipio | null>;
}

export function PaginaCrescimentoCliente({
  cidades,
  movimentacoes,
  ranking,
  meta,
  ...
  if (perfil) {
    ...
    maioresCrescimentosAbsolutos = movimentacoes.maioresCrescimentosAbsolutos;
    maioresRetracoesAbsolutas = movimentacoes.maioresRetracoesAbsolutas;
    maioresCrescimentosPercentuais = movimentacoes.maioresCrescimentosPercentuais;
    maioresRetracoesPercentuais = movimentacoes.maioresRetracoesPercentuais;
    maioresAvancosRanking = movimentacoes.maioresAvancosRanking;
    maioresExpansoesTerritoriais = movimentacoes.maioresExpansoesTerritoriais;
  }
